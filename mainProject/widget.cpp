    ...
    , ui(new Ui::Widget)
{
    ...
    initpopline->setGeometry(this->width()*0.25+175,this->height()*0.4,100,initpoplab->height());
    ...
    initinfline->setGeometry(this->width()*0.25+175,this->height()*0.4+50,100,initinflab->height());
    ...
    initpolBox->setGeometry(this->width()*0.25+175,this->height()*0.4+100,initpolBox->width()+100,initinflab->height());
